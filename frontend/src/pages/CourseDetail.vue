			...
			<div class="flex justify-between w-full">
				<div class="md:w-2/3">
					...
					<div class="flex items-center">
						...
						>
							<Star class="w-5 h-5 text-gray-100 fill-orange-500" />
							<span class="ml-1">
								{{ course.data.rating }}
							</span>
						</Tooltip>
					...
					<CourseCardOverlay :course="course" class="mb-4 md:hidden" />
					<div
...
import { Badge, Breadcrumbs, createResource, Tooltip } from 'frappe-ui'
